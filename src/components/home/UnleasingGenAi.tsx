...
const UnleasingGenAi = () => {
    return (
        <section className="max-w-[1440px] mx-auto relative pb-[60px] md:pb-[80px] lg:pb-[120px]">
            <div className="flex flex-col items-center md:flex-row gap-[20px] md:gap-[66px] px-[16px] md:px-[24px] xl:px-[100px]">
                <div className="w-full md:max-w-[610px]">
                    <h1 className="w-full max-w-[307px] sm:w-full md:max-w-[609px] text-[28px] md:text-[44px] font-bold leading-[26px] md:leading-[52px] tracking-[0.42px] md:tracking-[0.66px] font-polySans">Unleashing Gen AI for Unprecedented Cost Efficiency</h1>

                    <div className="mt-[20px] md:mt-[30px]">
                        <p className="text-[14px] sm:text-[16px] leading-[22px] sm:leading-[24px] font-general-sans">
                            The McKinsey Research emphasizes the significant impact of Generation AI (Gen AI) on customer care, projecting potential productivity gains of 30% to 40% of current function costs. Companies employing Gen AI technologies, like virtual agents and chatbots, in customer-facing roles can drastically lower contact center operational expenses, thereby greatly enhancing their return on investment (ROI).
                        </p>
                        <p className="text-[14px] sm:text-[16px] leading-[22px] sm:leading-[24px] font-general-sans mt-[22px] md:mt-[25px]">
                            Incorporating Gen AI into customer care strategies goes beyond adopting advanced technology; it revolutionizes the economics of customer service, offering unprecedented efficiency and financial advantages.
                        </p>
                    </div>
                        ...
                        <div className="w-[36px] md:w-[48px] h-[36px] md:h-[48px] rounded-full bg-white p-[5px] m-[4px] flex justify-center items-center">
                            ...
                            <span className="flex md:hidden">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    <g clip-path="url(#clip0_2061_638)">
                ...
                <div className="w-full md:max-w-[560px] md:max-h-[580px]">
                    <figure className="w-full h-auto md:max-w-[560px] md:max-h-[580px] rounded-[20px] md:rounded-[50px] overflow-hidden md:mt-[25px]">
                        <Image
                            src="/images/home/unleasing-gen-ai/laptop-girl.png"
                            width={560}
                            height={580}
                            alt="laptop girl image"
