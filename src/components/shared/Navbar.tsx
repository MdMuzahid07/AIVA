...
const Navbar = () => {
    ...
    return (
        <header className="max-w-[1440px] mx-auto w-full mt-[20px] px-[16px] md:px-[24px] lg:px-[0px]">
            <nav className="max-w-[1240px] mx-auto flex items-center border justify-between  pl-[22px] pr-[8px] w-full h-[60px] rounded-[50px] bg-[rgba(255,255,255,0.60)] backdrop-blur-[3px] relative">
                <Link href="/">
                ...
                {
                    showNav && (
                        <div className="flex md:hidden w-[343px] h-[386px] absolute right-0 top-[60px] shadow bg-white rounded-[30px] backdrop-blur-[3px] p-[20px]">
